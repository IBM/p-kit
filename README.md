...
p-kit has also been used for experimental language-model implementations. See the [p-kit Language Model Project](https://github.com/IBM/p-kit/wiki/p%E2%80%90kit-Language-Model-Project) wiki page.
